...
//BROSSAM - GTM DATA LAYER: ADD TO CART
function samGTMAddToCart() {
    ...
    dataLayer.push({
        ...
        //             'id': "samProductID",
        //             'name': "samProductName",
        //             'price': parseFloat(google_tag_params.ecomm_totalvalue),
        //             'brand': "samProductBrand",
        //             'category': "samProductCategory",
        //             'variant': "samProductSKUINFO",
        //             'quantity': parseInt($("#SIQTY").val())
        //         }]
        //     }
        // }
    });
...
//BROSSAM - GTM DATA LAYER: REMOVE FROM CART
function samGTMRemoveFromCart() {
...
return true;
    ...
    if(errors=="N"){
       ...
       dataType: 'html',
        ...
        success: function(html){ 
            if(html=="S"){ 
                        samGTMAddToCart();  //Brossam: GTM Data Layer
                        miniCart();
                    }
            else{hideWait();
                alert("Error happened...please add to cart again!");               
...
function headerLogin(){
    ...
    $.ajax({
        ...
        type: "post",
        dataType: 'html',
        data: 'SIUSER='+username.val()+'&SIPSWD='+password.val(),
        success: function(html){
            hideWait();
             switch (html){
                 case("S"):
