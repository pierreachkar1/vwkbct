...
e("#navigation li.menuf").on("mouseenter",function(){
   ...
   if (dealsId == "div000000000000142") {
       //document.getElementById('navigation-dropdown').style.width = "420px";
       //var leftPos = document.getElementById('deal--nav').getBoundingClientRect().left - 325;
       //document.getElementById('navigation-dropdown').style.left =  leftPos + "px";
       ...
       //decide LEFT position for dropdown nav
		...
		var dealNavWidth = (currentWidth - dealNavXPos - navigationXPos) + 365;
       ...
       //Change width and left back to default values
