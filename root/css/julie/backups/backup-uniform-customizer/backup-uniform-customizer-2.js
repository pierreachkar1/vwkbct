$(document).ready(function() {
	...
	const hatIDs = ['uc_hat_1', 'uc_hat_2'];
	const socksIDs = ['uc_socks_1', 'uc_socks_2'];
	const allIDs = [...coatIDs, ...pantsIDs, ...hatIDs, ...socksIDs];
	...
	initializeSection("uc_hat_section", hatProductList);
			...
			$(`#${sectionName} .carousel`).append(`
					<div class="b5-active">
							<div class="card justify-content-between">
									...
									<div>
											<button class="product__customize btn btn-primary fs-6 w-100" id="btn_${product[5]}" onclick="samUC_ToggleCategoryDiv('${product[5]}')">Customize</button>
									</div>
							</div>
					</div>
			`);
