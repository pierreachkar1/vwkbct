    ...
    if (document.getElementsByClassName('stocktooltip').length > 0) {
        for (var i = 0; i < document.getElementsByClassName('stocktooltip').length; i++) {
            if (
                ...
                document.getElementsByClassName('stocktooltip')[i].style.color = '#333333';
                document.getElementsByClassName('stocktooltip')[i].style.fontWeight = '700';
                document.getElementsByClassName('stocktooltip')[i].style.fontStyle = 'italic';
                document.getElementsByClassName('stocktooltip')[i].style.textTransform = 'capitalize';
                document.getElementsByClassName('stocktooltip')[i].innerHTML = "Order now! Check your email for shipping details";
            }
        }
    }
...
$(document).ready(function(){
    ...
    if (document.getElementById('samGallsLogoBottomABTest')) {
        if (document.getElementById('samGallsLogoBottomABTest').alt == "Galls_Variance_2") {
            if (document.getElementById('sam--sezzle--wrapper')) {
                document.getElementById('sam--sezzle--wrapper').style.display = 'none';
            } else if (document.getElementsByClassName('sam-sezzle-div-cart-page').length > 0) {
                document.getElementsByClassName('sam-sezzle-div-cart-page')[0].style.display = 'none';
            } else {
                //Other pages
            }
        }
