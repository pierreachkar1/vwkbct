...
if (document.getElementById('samGallsLogoABTest')) {

    //IN STOCK
    if (document.getElementById('samGallsLogoABTest').alt == "variance1_instock") {
        if (document.getElementById('style')) {
            var samPDPTestedStyles = ['BG237', 'RS021', 'RS313', 'FZ153'];
            for (var i = 0; i < samPDPTestedStyles.length; i++) {
                if (document.getElementById('style').value == samPDPTestedStyles[i]) {
                    if (document.getElementsByClassName('stocktooltip').length > 0) {
                        document.getElementsByClassName('stocktooltip')[0].innerHTML = "In Stock";  //MESSAGE

                        //Add Event to Button
                        if (document.getElementById('samPDPAddToCartBtn')) {
                            document.getElementById('samPDPAddToCartBtn').setAttribute("onclick","addToCartItem();ga('send', 'event', 'AddToCartButtonABTest', 'click', 'ClickedAddToCartButton')");
                        }

                        //Disable click event on option
                        if (document.getElementById('opv1UL')) {
                            document.getElementById('opv1UL').style.pointerEvents = 'none';
                        }
                    }
                }
            }
    ...
    //SHOW NOTHING
    } else if (document.getElementById('samGallsLogoABTest').alt == "variance2_nothing") {
        if (document.getElementById('style')) {
            var samPDPTestedStyles = ['BG237', 'RS021', 'RS313', 'FZ153'];
            for (var i = 0; i < samPDPTestedStyles.length; i++) {
                if (document.getElementById('style').value == samPDPTestedStyles[i]) {
                    if (document.getElementsByClassName('stocktooltip').length > 0) {
                        document.getElementsByClassName('stocktooltip')[0].innerHTML = "";  //MESSAGE
                        //Add Event to Button
                        if (document.getElementById('samPDPAddToCartBtn')) {
                            document.getElementById('samPDPAddToCartBtn').setAttribute("onclick","addToCartItem();ga('send', 'event', 'AddToCartButtonABTest', 'click', 'ClickedAddToCartButton')");
                        }
