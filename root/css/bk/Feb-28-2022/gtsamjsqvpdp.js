...
if ((window.location.href.indexOf(".galls.com/gear-bags") > 0) || (window.location.href.indexOf(".galls.com/tactical-gloves") > 0)) {
    ...
    if (document.getElementById('samPDPAddToCartBtnQuickView')) {
        document.getElementById('samPDPAddToCartBtnQuickView').setAttribute("onclick","addToCartQV();ga('send', 'event', 'AddToCartButtonFeaturedProduct', 'click', 'ClickedAddToCartButton')");
    }
}
