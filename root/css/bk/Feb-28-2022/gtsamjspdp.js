...
if ((document.referrer.indexOf(".galls.com/gear-bags") > 0) || (document.referrer.indexOf(".galls.com/tactical-gloves") > 0)) {
    //Add Event to Button
    if (document.getElementById('samPDPAddToCartBtn')) {
        document.getElementById('samPDPAddToCartBtn').setAttribute("onclick","addToCartItem();ga('send', 'event', 'AddToCartButtonFeaturedProduct', 'click', 'ClickedAddToCartButton')");
    }
}
