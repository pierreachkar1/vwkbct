...
samStockMessageABTest();
    ...
    //GA Event
    if (document.getElementById('samPDPAddToCartBtnQuickView')) {
        document.getElementById('samPDPAddToCartBtnQuickView').setAttribute("onclick","addToCartQV();ga('send', 'event', 'AddToCartBtnStockMsgABTest', 'click', 'ClickedAddToCartButton')");
    }
    ...
    if (document.getElementById('sam--product--not--available--quickview')) {
        ...
        if (document.getElementById('sam--product--not--available--quickview').getElementsByTagName('p').length > 0) {
            ...
            if (document.getElementById('Qstyle')) {
                ...
                } else if (document.getElementById('Qstyle').getAttribute("value") == "BG236") {
                    //Show Alternative Products
                    var arrSamAltSimilarProductsQV = 
                    [
                        [  
                ...
                } else if (document.getElementById('Qstyle').getAttribute("value") == "FL1380") {
                    //Show Alternative Products
                    var arrSamAltSimilarProductsQV = 
                    [
                        [  
                ...
                } else if (document.getElementById('Qstyle').getAttribute("value") == "FL1836") {
                    //Show Alternative Products
                    var arrSamAltSimilarProductsQV = 
                    [
                        [  
                ...
                } else if (document.getElementById('Qstyle').getAttribute("value") == "HW1596") {
                    //Show Alternative Products
                    var arrSamAltSimilarProductsQV = 
                    [
                        [  
...
//SHOW HOLSTER FINDER LINK (No /holsters-finder included since it already there)
var arrNeededHolsterCategory = [  ".com/equipment", 
                                ".com/holsters-duty-gear", 
                                ".com/holsters", //share "holsters" => < 3
                                ".com/duty-holsters", 
                                ".com/concealed-carry-holsters",
                                ".com/ankle-holsters",
                                ".com/inside-waistband-holsters",
                                ".com/outside-waistband-holsters",
                                ".com/shoulder-holsters",
                                ".com/tactical-holsters"];
