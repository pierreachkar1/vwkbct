...
function samCloseZoomDivPDP() {
    ...
    //1 of 2: For Add To Cart Mobile AB TEST in PDP => Show button at bottom
    ...
    //END 1 of 2: For Add To Cart Mobile AB TEST in PDP
            ...
            if (document.getElementById('style')) {
                if (
                    ...
                    [
                        [  
                            "BG043",
                            "Galls Field Equipment Bag", 
                            "https://www.galls.com/photos/styles/BG043_330_1.JPG",
                            "https://www.galls.com/galls-field-equipment-bag"
                        ],
                        [  
                            "BG186",
                            "Galls Duffel Bag", 
                    ...
                    [
                        ...
                        [  
                            "NP166",
                            "Bianchi AccuMold Single Cuff Case", 
                            "https://www.galls.com/photos/styles/NP166_330_1.JPG",
                            "https://www.galls.com/bianchi-accumold-single-cuff-case"
                        ]
                    ];
                    ...
                    [
                        ...
                        [  
                            "CM126",
                            "5IVE Star Gear DLG-5S Drop Leg Gas Mask Carrier", 
                            "https://www.galls.com/photos/styles/CM126_BLK_500_1.JPG",
                            "https://www.galls.com/5ive-star-gear-dlg-5s-drop-leg-gas-mask-carrier"
                        ]
                        // [  
                        //     "TE080",
                    ...
                    [
                        ...
                        // [  
                        //     "BG1889",
                        //     "Vertx 45L Contingency Duffel Bag", 
                        //     "https://www.galls.com/photos/styles/BG1889_BLKH_300.JPG",
                        //     "https://www.galls.com/vertx-45l-contingency-duffel-bag"
                        // ]
                    ];
                ...
                } else if (document.getElementById('style').getAttribute("value") == "BG236") {
                    //Show Alternative Products
                    var arrSamAltSimilarProducts = 
                    [
                        [  
                        ...
                        [  
                            "BB098",
                            "5.11 Tactical Rush LBD Lima Duffle Bag", 
                            "https://www.galls.com/photos/styles/BB098_BLK_330_1.JPG",
                            "https://www.galls.com/5-11-tactical-rush-lbd-lima-duffle-bag"
                        ]
                    ];
    
                    samShowSimilarProductsPDP(arrSamAltSimilarProducts);
                    
                } else if (document.getElementById('style').getAttribute("value") == "FL1380") {
                    //Show Alternative Products
                    var arrSamAltSimilarProducts = 
                    [
                        [  
                            ...
                            "https://www.galls.com/photos/styles/FH159_1500_1500_1.jpg",
                            "https://www.galls.com/streamlight-protac-hl-flashlight"
                        ],
                        [  
                            "FZ344",
                            "Streamlight ProTac HL-X Dual-Fuel High-lumen Tactical Light", 
                            "https://www.galls.com/photos/styles/FZ344_BLK_330_1.JPG",
                            "https://www.galls.com/streamlight-protac-hl-x-dual-fuel-high-lumen-tactical-light"
                        ],
                        [  
                            "FL399",
                            "Streamlight ProTac HL USB", 
                            "https://www.galls.com/photos/styles/FL399_BLK_330_1.jpg",
                            "https://www.galls.com/streamlight-protac-hl-usb"
                        ]
                    ];
    
                    samShowSimilarProductsPDP(arrSamAltSimilarProducts);
                    
                } else if (document.getElementById('style').getAttribute("value") == "FL1836") {
                    //Show Alternative Products
                    var arrSamAltSimilarProducts = 
                    [
                        [  
                            "FL571",
                            "Streamlight TLR-1 C4 LED Rail Mounted Gun Light", 
                            "https://www.galls.com/photos/styles/FL571_330_1.JPG",
                            "https://www.galls.com/streamlight-tlr-1-tactical-led-gun-light"
                        ],
                        [  
                            "FL1805",
                            "Streamlight TLR-7 Sub Weapon Light", 
                            "https://www.galls.com/photos/styles/FL1805_BLK_300_1.JPG",
                            "https://www.galls.com/streamlight-tlr-7-sub-weapon-light"
                        ],
                        [  
                            "FL1348",
                            "Streamlight TLR-7 Weapon Light", 
                            "https://www.galls.com/photos/styles/FL1348_330_1.JPG",
                            "https://www.galls.com/streamlight-tlr-7-weapon-light"
                        ]
                    ];
    
                    samShowSimilarProductsPDP(arrSamAltSimilarProducts);
                    
                } else if (document.getElementById('style').getAttribute("value") == "HW1596") {
                    //Show Alternative Products
                    var arrSamAltSimilarProducts = 
                    [
                        [  
                            "HD115",
                            "HWI Gear Watch Cap", 
                            "https://www.galls.com/photos/styles/HD115_BLK_330_1.jpg",
                            "https://www.galls.com/hwi-gear-watch-cap"
                        ],
                        [  
                            "HW558",
                            "Rothco Wintuck Watch Cap", 
                            "https://www.galls.com/photos/styles/HW558_BLK_330_1.jpg",
                            "https://www.galls.com/rothco-wintuck-watch-cap"
                        ],
                        [  
                            "HW555",
                            "Rothco Acrylic Watch Cap", 
                            "https://www.galls.com/photos/styles/HW555_BLK_330_1.JPG",
                            "https://www.galls.com/rothco-acrylic-watch-cap"
                        ]
                    ];
...
$(document).ready(function() {
        ...
        if (document.getElementsByName("PAGETYPE")[0].value == "PDP") {
            ...
            if (document.getElementById('sam--product--not--available')) {
                ...
                if (document.getElementById('sam--product--not--available').getElementsByTagName('p').length > 0) {
                    ...
                    //Initially, show the bottom Add To Cart button
                    document.getElementById('AddToCartBtnForABTest').classList.add("samShowAddToCartBottom");
                    ...
                    var samAddToCartObserver = new IntersectionObserver(function(entries) {
                        if(entries[0].isIntersecting === true) {
                            ...
                            if (window.pageYOffset > 1000) {
                                document.getElementById('AddToCartBtnForABTest').classList.add("samShowAddToCartTop");
                                document.getElementById('AddToCartBtnForABTest').classList.remove("samShowAddToCartBottom");
                            } else {
                                document.getElementById('AddToCartBtnForABTest').classList.remove("samShowAddToCartTop");
                                document.getElementById('AddToCartBtnForABTest').classList.add("samShowAddToCartBottom");
    ...
    //END 2 of 2: For Add To Cart Mobile AB TEST in PDP


    //For STOCK Message AB Test
    samStockMessageABTest();

        //Add GA Event
        //Regular ADD TO CART BUTTON
        if (document.getElementById('samPDPAddToCartBtn')) {
            document.getElementById('samPDPAddToCartBtn').setAttribute("onclick","addToCartItem();ga('send', 'event', 'AddToCartBtnStockMsgABTest', 'click', 'ClickedAddToCartButton')");
        }

        //Floated ADD TO CART BUTTON
        if (document.getElementById('AddToCartBtnForABTest')) {
            document.getElementById('AddToCartBtnForABTest').getElementsByTagName('a')[0].setAttribute("onclick","addToCartItem();ga('send', 'event', 'AddToCartBtnStockMsgABTest', 'click', 'ClickedAddToCartButton')");
        }
    //END For STOCK Message AB TEST
