...
//         if (document.getElementById('Qsku')) {
//             var samPDPQVTestedStyles = ['BG237', 'RS021', 'RS313', 'FZ153'];
//             for (var i = 0; i < samPDPQVTestedStyles.length; i++) {
//                 if (document.getElementById('Qsku').innerHTML == samPDPQVTestedStyles[i]) {
...
//                         if (document.getElementById('Qopv1UL')) {
//                             document.getElementById('Qopv1UL').style.pointerEvents = 'none';
//                         }
//                     }
//                 }
//             }
