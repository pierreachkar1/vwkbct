...
$( document ).ready(function() {
    ...
    if (document.getElementById('size-fit-more-brand')) {
        ...
        '    <li><strong>Inseam:</strong> Measure a similar pant that fits you well. Measure along the inseam, from the crotch seam to the bottom of the hem.</li>'+
        '    <li><strong>Gloves:</strong> Measure across palm of your hand from where your thumb and index finger meet.</li>'+
        '    <li><strong>Women\'s Boot Sizing:&nbsp;</strong>For all of our lady friends looking for boots, the boot industry is very limited. Sadly, there are very few manufacturers that design boots in female sizes. Below is a sizing chart on how to convert a men boot sizes to a women boot sizes.</li>'+
        '</ul>'+
        '<div style="overflow-x:auto;"><table>'+
        '    <tbody>'+
        '        <tr>'+
        ...
        '<ul>'+
        '	<li><a href="#HelmetOPSin">Helmet Sizeing (in)</a></li>'+
        ...
        '	<li><a href="#FlightsuitRothco">Flightsuits</a></li>'+
